...
PAGES = [
    st.Page(price_prediction.render, title="Price Prediction", url_path="price-prediction", default=True),
    st.Page(recommendations.render, title="Recommendations", url_path="recommendations"),
    st.Page(sector_map.render, title="Sector Map", url_path="sector-map"),
    st.Page(market_insights.render, title="Market Insights", url_path="market-insights"),
]
